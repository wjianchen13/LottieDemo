...
public class BadgeOptions {
    ...
    private ICallBack<BadgeManager.DrawableProxy> callBack;

    BadgeOptions(Context context){
        this.context = context;
    }

    public @NonNull BadgeManager.DrawableProxy request(){
        return BadgeManager.getInstance().getDrawable(this);
    }

    public BadgeOptions id(int id){
        this.id = id;
        return this;
    }

    public BadgeOptions id(String idStr){
        id = parseId(idStr);
        return this;
    }
    ...
    public BadgeOptions isHolder(boolean isHolder){
    ...
    public BadgeOptions defTxtColor(@ColorInt int defTxtColor){
        this.defTxtColor = defTxtColor;
        return this;
    }

    public BadgeOptions defTxtBold(boolean defTxtBold){
    ...
    public BadgeOptions ignoreAnim(boolean ignoreAnim) {
        this.ignoreAnim = ignoreAnim;
        return this;
    }

    public BadgeOptions scaleX(float scaleX){
        this.scaleX = scaleX;
        return this;
    }

    public BadgeOptions scaleY(float scaleY){
        this.scaleY = scaleY;
        return this;
    }

    BadgeOptions height(int height){
        this.height = height;
        return this;
    }

    public BadgeOptions normalHeight(int normalHeight){
        this.normalHeight = normalHeight;
        return this;
    }

    public BadgeOptions expandHeight(int expandHeight){
        this.expandHeight = expandHeight;
        return this;
    }

    public BadgeOptions isNotExpand(boolean isNotExpand){
    ...
    public BadgeOptions cacheKey(String cacheKey){
        this.cacheKey = cacheKey;
        return this;
    }

    public BadgeOptions placeDelay(long placeDelay){
        this.placeDelay = placeDelay;
        return this;
    }

    public BadgeOptions spanAlign(int spanAlign){
        this.spanAlign = spanAlign;
        return this;
    }

    public BadgeOptions spanAlignCenter(){
        this.spanAlign = XIU_ALIGN_CENTER;
        return this;
    }

    public BadgeOptions spanAlignBottom(){
        this.spanAlign = XIU_ALIGN_BOTTOM;
        return this;
    }

    public BadgeOptions spanAlignTiling(){
        this.spanAlign = XIU_ALIGN_TILING;
        return this;
    }

    public BadgeOptions isPauseAnim(boolean isPauseAnim){
        this.isPauseAnim = isPauseAnim;
        return this;
    }

    public BadgeOptions callback(ICallBack<BadgeManager.DrawableProxy> callBack){
        this.callBack = callBack;
        return this;
    }

    public ICallBack<BadgeManager.DrawableProxy> getCallBack() {
        return callBack;
    }

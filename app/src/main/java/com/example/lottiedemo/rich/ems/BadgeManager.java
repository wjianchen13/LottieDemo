...
public class BadgeManager {
    ...
    public static BadgeOptions with(Context context){
    ...
    @NonNull
    DrawableProxy getDrawable(@NonNull BadgeOptions options){
...
//        beans.add(mNormalBeans.get(3));
    ...
    public boolean hasEntity(String idStr){
        return hasEntity(BadgeOptions.parseId(idStr));
    }
    ...
    private @NonNull Drawable createDefaultDrawable(Context context, String name, @NonNull BadgeOptions options){
...
//        emTextView.setPadding(padding, padding, padding, padding);
    ...
    public static class DrawableProxy{
        @NonNull BadgeOptions options;
        @NonNull Context context;
        @NonNull Drawable drawable;
        boolean isFromCache;

        private DrawableProxy(@NonNull BadgeOptions options, @NonNull Drawable drawable, boolean isFromCache){
        ...
        private DrawableProxy(@NonNull BadgeOptions options, @NonNull Drawable drawable){
